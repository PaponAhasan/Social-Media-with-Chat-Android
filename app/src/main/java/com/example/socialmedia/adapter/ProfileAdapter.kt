...
class ProfileAdapter(options: FirestoreRecyclerOptions<Post>, private val listener: IPostProfileAdapter) :
    FirestoreRecyclerAdapter<Post, ProfileAdapter.ProfileViewHolder>(
        options
    ) {
